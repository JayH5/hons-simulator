...
/**
 * XGE model for the Los Altos Hills ant trail problem in the Epox language.
 */
public class LosAltosHillsTrail extends AntTrail {
	 ...
	 */
	public static final Point[] FOOD_LOCATIONS = {new Point(1, 0), new Point(2, 0), new Point(3, 0), new Point(3, 1),
