...
/**
 * XGR model for the John Muir ant trail problem in the Groovy language.
 */
public class JohnMuirTrail extends AntTrail {
	 ...
	 */
	public static final Point[] FOOD_LOCATIONS = {new Point(1, 0), new Point(2, 0), new Point(3, 0), new Point(4, 0),
