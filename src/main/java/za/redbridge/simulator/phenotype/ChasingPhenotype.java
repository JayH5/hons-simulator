...
public class ChasingPhenotype implements Phenotype {
    ...
    public ChasingPhenotype() {
        ProximitySensor leftSensor = new ProximitySensor((7/4.0) * Math.PI);
        ProximitySensor forwardSensor = new ProximitySensor(0.0);
        ProximitySensor rightSensor = new ProximitySensor(Math.PI/4);
