 ...
 */
public class CCHNEATMutateWeights extends CCHNEATMutation {
    /**
     ...
     */
    public CCHNEATMutateWeights(final SelectLinks theLinkSelection,
    ...
    public void performOperation(final Random rnd, final Genome[] parents,
        ...
        final NEATGenome target = obtainGenome(parents, parentIndex, offspring,
                offspringIndex);
        final double weightRange = ((CCHNEATPopulation)getOwner().getPopulation()).getWeightRange();
