 ...
 *
 */
public class CCHNEATGenome extends BasicGenome implements Cloneable, Serializable {
     ...
     *            The other genome.
     */
    public CCHNEATGenome(final CCHNEATGenome other) {
     ...
     *            The output count.
     */
    public CCHNEATGenome(final List<NEATNeuronGene> neurons,
     ...
     */
    public CCHNEATGenome(final Random rnd, final CCHNEATPopulation pop,
