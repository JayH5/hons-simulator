 ...
 */
public class CCHNEATMutateAddNode extends CCHNEATMutation {
    ...
    public void performOperation(final Random rnd, final Genome[] parents,
        ...
        final CCHNEATPopulation pop = ((CCHNEATPopulation) target.getPopulation());
        ...
        final NEATInnovation innovation = ((CCHNEATPopulation)getOwner().getPopulation()).getInnovations()
                .findInnovationSplit(from, to);

        // add the splitting neuron
        final ActivationFunction af = ((CCHNEATPopulation)getOwner().getPopulation())
