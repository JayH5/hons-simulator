 ...
 */
public abstract class CCHNEATMutation implements EvolutionaryOperator {
    ...
    public NEATNeuronGene chooseRandomNeuron(final NEATGenome target,
        ...
        // neurons
        if (!choosingFrom) {
            final int ac = ((CCHNEATPopulation) target.getPopulation())
                    .getActivationCycles();
            if (ac == 1) {
    ...
    public void createLink(final NEATGenome target, final long neuron1ID,
        ...
        final NEATInnovation innovation = ((CCHNEATPopulation) target
